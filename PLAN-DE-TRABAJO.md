...
- [x] Migración `20260924050000_incremento4_r2_cifrado_importacion_csv` — agrega `cifradoVersion`/`cifradoClaveId`/`cifradoDek`/`cifradoDekIv`/`cifradoDekAuthTag` a `ImportacionCsv` (metadata de la DEK envuelta, nunca el contenido ni la DEK en claro). Escrita a mano, **pendiente de validar en Windows** (mismo procedimiento de siempre).
